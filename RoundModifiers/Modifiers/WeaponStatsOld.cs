...
public class WeaponStatsOld : Modifier
{
    ...
    public static void OnRoundStart()
        ...
        public static void OnGiveItem(ItemAddedEventArgs ev)
        {
            ...
            {
                Stats.GetWeaponStats(firearm)?.Change();
            }
        }
        ...
        public static void OnInspectFirearm(InspectFirearmEventArgs ev)
        {
            ...
            Stats weaponStats = Stats.GetWeaponStats(ev.Firearm);
        ...
        public static void ChangeWeaponStats(AccessFirearmBaseStatsEventArgs ev)
        {
            ...
            Stats stats = Stats.GetWeaponStats(ev.Firearm);
    ...
    public class Stats
    {
        public static Dictionary<ushort, Stats> WeaponStatsDict = new Dictionary<ushort, Stats>();

        public static Stats GetWeaponStats(Firearm item)
        {
            ...
            {
                WeaponStatsDict[item.Serial] = new Stats(item);
